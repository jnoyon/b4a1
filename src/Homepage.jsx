...
function Homepage() {
  return (
    <div class="w-full min-h-screen relative bg-[#F7F5F3] overflow-x-hidden flex flex-col justify-start items-center">
      <div class="relative flex flex-col justify-start items-center w-full">
        <div class="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
          <div class="w-[1px] h-full absolute left-4 sm:left-6 md:left-8 lg:left-0 top-0 bg-[rgba(55,50,47,0.12)] shadow-[1px_0px_0px_white] z-0"></div>

          <div class="w-[1px] h-full absolute right-4 sm:right-6 md:right-8 lg:right-0 top-0 bg-[rgba(55,50,47,0.12)] shadow-[1px_0px_0px_white] z-0"></div>

          <div class="self-stretch pt-[9px] overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            <div class="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0">
              ...
              <div class="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                <div class="flex justify-center items-center">
                  <div class="flex justify-start items-center">
                    <div class="flex flex-col justify-center text-[#2F3037] text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-5 cursor-pointer">
                      Brillance
                    </div>
                  </div>
                  <div class="pl-3 sm:pl-4 md:pl-5 lg:pl-5 flex justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
                    <div class="flex justify-start items-center">
                      <div class="flex flex-col justify-center text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium leading-[14px] cursor-pointer">
                        Products
                      </div>
                    </div>
                    <div class="flex justify-start items-center">
                ...
                <div class="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
                  <div class="px-2 sm:px-3 md:px-[14px] py-1 sm:py-[6px] bg-white shadow-[0px_1px_2px_rgba(55,50,47,0.12)] overflow-hidden rounded-full flex justify-center items-center cursor-pointer">
                    <div class="flex flex-col justify-center text-[#37322F] text-xs md:text-[13px] font-medium leading-5">
                      Log in
                    </div>
                  </div>
                </div>
            ...
            <div class="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
                ...
                <div class="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  <div class="w-full md:flex-1 self-stretch px-6 py-5 overflow-hidden flex flex-col justify-start items-start gap-2 cursor-pointer relative border-b md:border-b-0 border-l-0 border-r-0 md:border border-[#E0DEDB]/80">
                    ...
                    <div class="self-stretch text-[#605A57] text-[13px] md:text-[13px] font-normal leading-[22px] md:leading-[22px]">
                      Streamline customer subscriptions and billing with
                  ...
                  <div class="w-full md:flex-1 self-stretch px-6 py-5 overflow-hidden flex flex-col justify-start items-start gap-2 cursor-pointer relative last:border-b-0 border-b md:border-b-0 border-l-0 border-r-0 md:border border-[#E0DEDB]/80">
                    ...
                    <div class="self-stretch text-[#605A57] text-[13px] md:text-[13px] font-normal leading-[22px] md:leading-[22px]">
                      Keep your team aligned with shared dashboards and
              ...
              <div class="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                <div class="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div class="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 shadow-none overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                ...
                <div class="self-stretch px-2 overflow-hidden flex justify-start items-center bg-background border border-b border-l-0 border-r-0 border-t-0">
                  <div class="flex-1 py-12 md:py-16 flex flex-col md:flex-row justify-center items-end gap-6">
                    <div class="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
                      <img
                      ...
                      <div class="flex-1 px-6 py-6 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] overflow-hidden flex flex-col justify-start items-start gap-6">
                        <div class="self-stretch justify-start flex flex-col text-[#49423D] text-2xl md:text-[32px] font-medium leading-10 md:leading-[42px] h-auto tracking-tight">
                          "In just a few minutes, we transformed our data into
                          actionable insights. The process was seamless and
                          incredibly efficient!"
                        </div>
                        <div class="self-stretch flex flex-col justify-start items-start gap-1">
                          <div class="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.90)] text-lg font-medium leading-[26px]">
                            Jamie Marshall
                          </div>
                          <div class="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.70)] text-lg font-medium leading-[26px]">
                            Co-founder, Exponent
                          </div>
                        </div>
                      </div>
              ...
              <div class="w-full flex flex-col justify-center items-center gap-2 border-b border-[rgba(55,50,47,0.12)]">
                <div class="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div class="w-full max-w-[586px] px-6 py-5 shadow-none overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4">
                    <div class="px-[14px] py-[6px] bg-white shadow-[0px_0px_0px_4px_rgba(55,50,47,0.05)] overflow-hidden rounded-[90px] flex justify-start items-center gap-[8px] border border-[rgba(2,6,23,0.08)] shadow-xs">
                      <svg
                        width="12"
                        height="12"
                    ...
                    <div class="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] tracking-tight">
                      Choose the perfect plan for your business
                    </div>
                    <div class="self-stretch text-center text-[#605A57] text-base font-normal leading-7">
              ...
              <div class="w-full pt-10 flex flex-col justify-start items-start border-t border-[rgba(55,50,47,0.12)]">
                <div class="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
                  <div class="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
                    <div class="self-stretch flex justify-start items-center gap-3">
                      <div class="text-center text-[#49423D] text-xl font-semibold leading-4">
                        Brillance
                      </div>
                    </div>
                    <div class="text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px]">
                  ...
                  <div class="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
                    <div class="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
                      <div class="self-stretch text-[rgba(73,66,61,0.50)] text-sm font-medium leading-5">
                        Product
                      </div>
                      <div class="flex flex-col justify-end items-start gap-2">
                        <div class="text-[#49423D] text-sm font-normal leading-5 cursor-pointer hover:text-[#37322F] transition-colors">
                          Features
                        </div>
                        <div class="text-[#49423D] text-sm font-normal leading-5 cursor-pointer hover:text-[#37322F] transition-colors">
                          Pricing
                    ...
                    <div class="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
                      <div class="text-[rgba(73,66,61,0.50)] text-sm font-medium leading-5">
                        Company
                      </div>
                    ...
                    <div class="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
                      ...
                      <div class="flex flex-col justify-center items-center gap-2">
                        <div class="self-stretch text-[#49423D] text-sm font-normal leading-5 cursor-pointer hover:text-[#37322F] transition-colors">
                          Terms of use
                        </div>
                        <div class="self-stretch text-[#49423D] text-sm font-normal leading-5 cursor-pointer hover:text-[#37322F] transition-colors">
                          API Reference
